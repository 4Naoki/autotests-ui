...
class CreateCourseFormComponent(BaseComponent):
    ...
    @allure.step(
        'Fill create course form with values: title "{title}", estimated_time "{estimated_time}",'
        ' description "{description}", max_score "{max_score}", min_score "{min_score}"'
    )
    def fill(
            self,
            title: str,
    ...
    @allure.step(
        'Check visible create course form with values: title "{title}", estimated_time "{estimated_time}",'
        ' description "{description}", max_score "{max_score}", min_score "{min_score}"'
    )
    def check_visible(
            self,
